 ...
 */
export const submitContact = async (contactSubmission: ContactSubmission, options?: RequestInit): Promise<ContactResponse> => {
 ...
 */
export const getContacts = async ( options?: RequestInit): Promise<ContactMessage[]> => {

  return customFetch<ContactMessage[]>(getGetContactsUrl(),
  {
    ...options,
    method: 'GET'
